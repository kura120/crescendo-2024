...
struct PyTrampolineCfg_rev__SparkFlexExternalEncoder :
...
{
    using Base = rev::SparkFlexExternalEncoder;

    
    
    using override_base_KGetPosition_v = rev::SparkFlexExternalEncoder;
    
    using override_base_KGetVelocity_v = rev::SparkFlexExternalEncoder;
    
    using override_base_SetPosition_d = rev::SparkFlexExternalEncoder;
    
    using override_base_SetPositionConversionFactor_d = rev::SparkFlexExternalEncoder;
    
    using override_base_SetVelocityConversionFactor_d = rev::SparkFlexExternalEncoder;
    
    using override_base_KGetPositionConversionFactor_v = rev::SparkFlexExternalEncoder;
    
    using override_base_KGetVelocityConversionFactor_v = rev::SparkFlexExternalEncoder;
    
    using override_base_SetAverageDepth_j = rev::SparkFlexExternalEncoder;
    
    using override_base_SetMeasurementPeriod_j = rev::SparkFlexExternalEncoder;
    
    using override_base_KGetAverageDepth_v = rev::SparkFlexExternalEncoder;
    
    using override_base_KGetMeasurementPeriod_v = rev::SparkFlexExternalEncoder;
    
    using override_base_KGetCountsPerRevolution_v = rev::SparkFlexExternalEncoder;
    
    using override_base_SetInverted_b = rev::SparkFlexExternalEncoder;
    
    using override_base_KGetInverted_v = rev::SparkFlexExternalEncoder;
...
using PyTrampolineBase_rev__SparkFlexExternalEncoder =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_rev__SparkFlexExternalEncoder : PyTrampolineBase_rev__SparkFlexExternalEncoder<PyTrampolineBase, PyTrampolineCfg> {
    using PyTrampolineBase_rev__SparkFlexExternalEncoder<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_rev__SparkFlexExternalEncoder;




  using Type [[maybe_unused]] = typename rev::SparkFlexExternalEncoder::Type;
