...
class MyRobot(wpilib.TimedRobot):
    def robotInit(self):
        ...
        self.climber_speed = 0.4               #   Robot climber speed for switching climber position      (Hardcode)
    ...
    def teleopPeriodic(self):
        # self.robot.tankDrive(-self.controller.getLeftY() * 0.50, -self.controller.getRightY() *0.50)
        self.robot.tankDrive(-self.controller.getRawAxis(1) , -self.controller.getRawAxis(5) )
